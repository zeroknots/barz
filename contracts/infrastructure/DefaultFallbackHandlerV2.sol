...
contract DefaultFallbackHandlerV2 is IDiamondLoupe {
    ...
    function facets() external view override returns (Facet[] memory facets_) {
        ...
        facets_[1].functionSelectors[2] = IAccountFacetV2.executeSingle.selector;
        ...
        facets_[1].functionSelectors[5] = IAccountFacetV2.addValidatorSystem.selector;
        facets_[1].functionSelectors[6] = IAccountFacetV2.removeValidatorSystem.selector;
        facets_[1].functionSelectors[7] = IAccountFacetV2.getValidatorSystem.selector;

        facets_[2].facetAddress = tokenReceiverFacet;
        facets_[2].functionSelectors = new bytes4[](5);
        facets_[2].functionSelectors[0] = IERC721Receiver.onERC721Received.selector;
        facets_[2].functionSelectors[1] = IERC1155Receiver.onERC1155Received.selector;
        facets_[2].functionSelectors[2] = IERC1155Receiver.onERC1155BatchReceived.selector;
        facets_[2].functionSelectors[3] = IERC777Recipient.tokensReceived.selector;
        facets_[2].functionSelectors[4] = IERC677Receiver.onTokenTransfer.selector;
        ...
        facets_[3].functionSelectors[1] = IDiamondLoupe.facetFunctionSelectors.selector;
        ...
        facets_[3].functionSelectors[5] = IStorageLoupe.facetsFromStorage.selector;
        facets_[3].functionSelectors[6] = IStorageLoupe.facetFunctionSelectorsFromStorage.selector;
        facets_[3].functionSelectors[7] = IStorageLoupe.facetAddressesFromStorage.selector;
        facets_[3].functionSelectors[8] = IStorageLoupe.facetAddressFromStorage.selector;
        ...
        facets_[4].functionSelectors[3] = IMMSAFacet.executeFromExecutor.selector;
        facets_[4].functionSelectors[4] = IMMSAFacet.accountId.selector;
        facets_[4].functionSelectors[5] = IMMSAFacet.supportsExecutionMode.selector;
        ...
        facets_[4].functionSelectors[9] = IMMSAFacet.mmsaStaticFallback.selector;
        facets_[4].functionSelectors[10] = IMMSAFacet.initMMSA.selector;
        facets_[4].functionSelectors[11] = IMMSAFacet.getModulesPaginated.selector;
        facets_[4].functionSelectors[12] = IMMSAFacet.mmsaIsValidSignature.selector;
        ...
        facets_[5].functionSelectors[0] = IMSCAFacet.initializeMSCAModules.selector;
        ...
        facets_[5].functionSelectors[3] = IModuleManager.uninstallModule.selector;
        facets_[5].functionSelectors[4] = IModuleExecutor.executeFromModule.selector;
        facets_[5].functionSelectors[5] = IModuleExecutor.executeFromModuleExternal.selector;
        facets_[5].functionSelectors[6] = IStandardExecutor.execute.selector;
        facets_[5].functionSelectors[7] = IStandardExecutor.executeBatch.selector;
        facets_[5].functionSelectors[8] = IAccountLoupe.getExecutionFunctionConfig.selector;
        facets_[5].functionSelectors[9] = IAccountLoupe.getExecutionHooks.selector;
        facets_[5].functionSelectors[10] = IAccountLoupe.getPreValidationHooks.selector;
        facets_[5].functionSelectors[11] = IAccountLoupe.getInstalledModules.selector;
    }
        ...
        returns (bytes4[] memory facetFunctionSelectors_)
    {
        if (_facet == diamondCutFacet) {
            ...
            facetFunctionSelectors_[5] = IAccountFacetV2.addValidatorSystem.selector;
            facetFunctionSelectors_[6] = IAccountFacetV2.removeValidatorSystem.selector;
            facetFunctionSelectors_[7] = IAccountFacetV2.getValidatorSystem.selector;
        } else if (_facet == tokenReceiverFacet) {
            facetFunctionSelectors_[0] = IERC721Receiver.onERC721Received.selector;
            facetFunctionSelectors_[1] = IERC1155Receiver.onERC1155Received.selector;
            facetFunctionSelectors_[2] = IERC1155Receiver.onERC1155BatchReceived.selector;
            facetFunctionSelectors_[3] = IERC777Recipient.tokensReceived.selector;
            facetFunctionSelectors_[4] = IERC677Receiver.onTokenTransfer.selector;
        } else if (_facet == diamondLoupeFacet) {
            facetFunctionSelectors_[0] = IDiamondLoupe.facets.selector;
            facetFunctionSelectors_[1] = IDiamondLoupe.facetFunctionSelectors.selector;
            ...
            facetFunctionSelectors_[5] = IStorageLoupe.facetsFromStorage.selector;
            facetFunctionSelectors_[6] = IStorageLoupe.facetFunctionSelectorsFromStorage.selector;
            facetFunctionSelectors_[7] = IStorageLoupe.facetAddressesFromStorage.selector;
            facetFunctionSelectors_[8] = IStorageLoupe.facetAddressFromStorage.selector;
        } else if (_facet == mmsaFacet) {
            facetFunctionSelectors_[0] = IMMSAFacet.execute.selector;
            facetFunctionSelectors_[1] = IMMSAFacet.executeFromExecutor.selector;
            ...
            facetFunctionSelectors_[7] = IMMSAFacet.supportsExecutionMode.selector;
            ...
            facetFunctionSelectors_[11] = IMMSAFacet.getModulesPaginated.selector;
            facetFunctionSelectors_[12] = IMMSAFacet.mmsaIsValidSignature.selector;
            ...
            facetFunctionSelectors_[1] = IStandardExecutor.executeBatch.selector;
            facetFunctionSelectors_[2] = IModuleExecutor.executeFromModule.selector;
            facetFunctionSelectors_[3] = IModuleExecutor.executeFromModuleExternal.selector;
            facetFunctionSelectors_[4] = IMSCAFacet.mscaFallback.selector;
            facetFunctionSelectors_[5] = IMSCAFacet.initializeMSCAModules.selector;
            facetFunctionSelectors_[6] = IModuleManager.installModule.selector;
            facetFunctionSelectors_[7] = IModuleManager.uninstallModule.selector;
            facetFunctionSelectors_[8] = IAccountLoupe.getExecutionFunctionConfig.selector;
            facetFunctionSelectors_[9] = IAccountLoupe.getExecutionHooks.selector;
            facetFunctionSelectors_[10] = IAccountLoupe.getPreValidationHooks.selector;
            facetFunctionSelectors_[11] = IAccountLoupe.getInstalledModules.selector;
        }
    }
    ...
    function facetAddress(bytes4 _functionSelector) external view override returns (address facetAddress_) {
        if (
            _functionSelector == BaseAccount.validateUserOp.selector
                ...
                || _functionSelector == IAccountFacetV2.removeValidatorSystem.selector
            ...
            _functionSelector == IStandardExecutor.execute.selector
                ...
                || _functionSelector == IModuleExecutor.executeFromModuleExternal.selector
                ...
                || _functionSelector == IAccountLoupe.getExecutionFunctionConfig.selector
            ...
            _functionSelector == IERC721Receiver.onERC721Received.selector
                ...
                || _functionSelector == IERC1155Receiver.onERC1155BatchReceived.selector
            ...
            _functionSelector == IDiamondLoupe.facets.selector
                || _functionSelector == IDiamondLoupe.facetFunctionSelectors.selector
                ...
                || _functionSelector == IStorageLoupe.facetFunctionSelectorsFromStorage.selector
                || _functionSelector == IStorageLoupe.facetAddressesFromStorage.selector
