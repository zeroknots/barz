...
interface IMultiOwnerModule {
    ...
    /// @dev This function is installed on the account as part of module installation, and should
    ...
    /// @dev Assumes that the SCA's implementation of `domainSeparator` is this module's
