...
import {IPolicy} from "../../../facets/mmsa/interfaces/IPolicy.sol";
...
abstract contract PolicyBase is IPolicy {
    ...
    function checkUserOpPolicy(bytes32 id, UserOperation calldata userOp) external payable virtual returns (uint256);
