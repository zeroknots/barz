...
library LibFacetStorage {
    bytes32 constant K1_STORAGE_POSITION = keccak256("v0.trustwallet.diamond.storage.Secp256k1VerificationStorage");
    bytes32 constant R1_STORAGE_POSITION = keccak256("v0.trustwallet.diamond.storage.Secp256r1VerificationStorage");
    bytes32 constant GUARDIAN_STORAGE_POSITION = keccak256("v0.trustwallet.diamond.storage.GuardianStorage");
    bytes32 constant RECOVERY_STORAGE_POSITION = keccak256("v0.trustwallet.diamond.storage.RecoveryStorage");
    bytes32 constant RESTRICTION_STORAGE_POSITION = keccak256("v0.trustwallet.diamond.storage.RestrictionsStorage");
    bytes32 constant MIGRATION_STORAGE_POSITION = keccak256("v0.trustwallet.diamond.storage.SignatureMigrationStorage");
    bytes32 constant DIAMONDCUT_STORAGE_POSITION = keccak256("v0.trustwallet.diamond.storage.DiamondCutStorage");
    bytes32 constant LOCK_STORAGE_POSITION = keccak256("v0.trustwallet.diamond.storage.LockStorage");

    function k1Storage() internal pure returns (Secp256k1VerificationStorage storage ds) {
    ...
    function r1Storage() internal pure returns (Secp256r1VerificationStorage storage ds) {
    ...
    function guardianStorage() internal pure returns (GuardianStorage storage ds) {
    ...
    function recoveryStorage() internal pure returns (RecoveryStorage storage ds) {
    ...
    function restrictionsStorage() internal pure returns (RestrictionsStorage storage ds) {
    ...
    function migrationStorage() internal pure returns (SignatureMigrationStorage storage ds) {
    ...
    function diamondCutStorage() internal pure returns (DiamondCutStorage storage ds) {
